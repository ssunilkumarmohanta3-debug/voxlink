...
export default function RoleSelectScreen() {
  ...
  return (
    <View style={[s.root, { paddingTop: insets.top + 20, paddingBottom: insets.bottom + 30 }]}>
      ...
      <View style={s.cards}>
        {/* User Card */}
        <TouchableOpacity onPress={() => router.push("/user/auth/login")} activeOpacity={0.88} style={s.cardTouch}>
        ...
        {/* Host Card */}
        <TouchableOpacity onPress={() => router.push("/host/auth/host-login")} activeOpacity={0.88} style={s.cardTouch}>
